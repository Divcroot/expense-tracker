...
const Expense = () => {
  ...
  const handleDownloadExpenseDetails = async () => {
    try {
      ...
      console.error("Error in downloading expense details: ", error.response?.data?.message || error?.message)
      toast.error("Failed to download expense deatils. Please try again.")
    }
  }
  ...
  return (
    <DashboardLayout activeMenu="Expense">
      <div className='my-5 mx-auto'>
        ...
        {openAddExpenseModel && (
          <Modal isOpen={openAddExpenseModel} onClose={() => setOpenAddExpenseModal(false)} title="Add Expense">
