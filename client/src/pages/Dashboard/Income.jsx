...
const Income = () => {
  ...
  const handleDownloadIncomeDetails = async () => {
    try {
      ...
      console.error("Error in downloading income details: ", error.response?.data?.message || error?.message)
  ...
  return (
    <DashboardLayout activeMenu="Income">
      <div className='my-5 mx-auto'>
        ...
        {openAddIncomeModel && (
          <Modal isOpen={openAddIncomeModel} onClose={() => setOpenAddIncomeModal(false)} title="Add Income">
